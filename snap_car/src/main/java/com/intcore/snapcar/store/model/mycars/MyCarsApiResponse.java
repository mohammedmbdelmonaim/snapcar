package com.intcore.snapcar.store.model.mycars;
...
public class MyCarsApiResponse {
    @SerializedName("cars")
    private List<Favouriteable> favoritesData;

    @SerializedName("sold")
    private List<Favouriteable> soldesData;

    public List<Favouriteable> getFavoritesData() {
        return favoritesData;
    }

    public List<Favouriteable> getSoldesData() {
        return soldesData;
    }
