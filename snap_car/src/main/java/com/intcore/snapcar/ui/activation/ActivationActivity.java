...
import com.intcore.snapcar.ui.phasetworegisteration.PhaseTwoRegistrationActivityArgs;
...
/*
 *This class is responsible for Activating a new account and Forget password verification
 */
@ActivityScope
public class ActivationActivity extends BaseActivity
        implements ActivationScreen, AuthenticationOperationListener<DefaultUserDataApiResponse> {
    ...
    @Override
    public void registerReciever(BroadcastReceiver receiver, IntentFilter filter) {
//        registerReceiver(receiver, filter);
    }

    @Override
    public void setPinEntrycode(String code) {
        pinEntryEditText.setText(code.toCharArray(), 0, 4);
